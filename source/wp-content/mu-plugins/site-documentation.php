...
function redirect_old_content() {
	$path_redirects = [
		...
		'/documentation/article/administration-over-ssl/'                           => 'https://developer.wordpress.org/advanced-administration/wordpress/wp-config/',
		'/documentation/article/backing-up-your-database/'                          => 'https://developer.wordpress.org/advanced-administration/security/backup/',
		'/documentation/article/backing-up-your-wordpress-files/'                   => 'https://developer.wordpress.org/advanced-administration/security/backup/',
		...
		'/documentation/article/faq-troubleshooting-2/'                             => 'https://developer.wordpress.org/advanced-administration/wordpress/common-errors/',
		...
		'/documentation/article/htaccess/'                                          => 'https://developer.wordpress.org/advanced-administration/server/file-permissions/',
		'/documentation/article/https-for-wordpress/'                               => 'https://developer.wordpress.org/advanced-administration/security/https/',
		'/documentation/article/importing-content/'                                 => 'https://developer.wordpress.org/advanced-administration/upgrade/migrating/',
		...
		'/documentation/article/network-admin-settings-screen/'                     => 'https://developer.wordpress.org/advanced-administration/multisite/admin/',
		...
		'/documentation/article/optimization-caching/'                              => 'https://developer.wordpress.org/advanced-administration/performance/optimization/',
		'/documentation/article/phpmyadmin/'                                        => 'https://developer.wordpress.org/advanced-administration/upgrade/phpmyadmin/',
		'/documentation/article/post-formats/'                                      => 'https://developer.wordpress.org/advanced-administration/wordpress/site-architecture/',
